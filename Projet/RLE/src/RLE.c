    ...
    while (!feof(f_input)) {
        ...
        if (carac == '.'){
            ...
            if (scan_int == 0){
                ...
                // Sinon on met dans le fichier f_output le caractere le nombre de fois donne par l'entier
                while(entier != 0){
                    fprintf(f_output, "%c", carac);
                    entier--;
                }
